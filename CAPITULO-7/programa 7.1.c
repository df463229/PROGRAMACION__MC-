...
printf("\n");
fflush(stdin);
/*Luego de leer un caracter siempre es conveniente escribir la funcion fflush para limpiar
el bufer, porque generalmente queda con basura y genera un error en la ejecucion del programa.
el error se produce porque cuando se ingresa un dato se oprime el return y luego cuando
volvemos a leer un caracter o una cadena de caracteres se toma a ese return como el nuevo
dato ingresado. */
